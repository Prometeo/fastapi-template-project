...
class UserService:
    ...
    def create_user_service(self, user_create: UserCreate) -> User:
        hashed_password: str = hash_password(user_create.password)
        return create_user(self._db, user_create, hashed_password)

    def update_user_service(self, user_id: int, user_update: UserUpdate) -> User | None:
    ...
    def list_users_service(self) -> list[User]:
        return list_users(self._db)

    def get_user_by_id_service(self, user_id: int) -> User | None:
